package com.boilerplate.authservice.service;

import com.boilerplate.authservice.dto.AuthDto;
import com.boilerplate.authservice.dto.UserDto;
import com.boilerplate.authservice.exception.ServiceException;
import com.boilerplate.authservice.service.downstream.UserService;
...
public class AuthServiceTest {
    ...
    void authLoginException() {
        ...
        ServiceException usernamePasswordNotMatch = assertThrows(ServiceException.class, () -> {
    ...
    void authLoginException2() {
        ...
        ServiceException passwordNotMatch = assertThrows(ServiceException.class, () -> {
            authService.authLogin(authDtoList.get(0));
        });
    ...
    void userNotFound() {
        ...
        ServiceException userNotFound = assertThrows(ServiceException.class, () -> {
            authService.authLogin(authDtoList.get(0));
        });
